(() => {
    ...
    let center = [ 43.22580060874965, 76.9469765012456 ];
    function init() {
        let map = new ymaps.Map("map", {
            center,
            zoom: 13
        });
        let Myplacemark = new ymaps.Placemark([ 43.23386540055033, 76.957319099207 ], {}, {
            iconLayout: "default#image",
            iconImageHref: "https://cdn-icons-png.flaticon.com/512/684/684908.png",
            iconImageSize: [ 40, 40 ],
            iconImageOffset: [ 0, 0 ]
        });
        let Myplacemark2 = new ymaps.Placemark([ 43.22746386389458, 76.92822249581346 ], {}, {
            iconLayout: "default#image",
            iconImageHref: "https://cdn-icons-png.flaticon.com/512/684/684908.png",
            iconImageSize: [ 40, 40 ],
            iconImageOffset: [ 0, 0 ]
        });
        let Myplacemark3 = new ymaps.Placemark([ 43.21820554218417, 76.92856581856739 ], {}, {
            iconLayout: "default#image",
            iconImageHref: "https://cdn-icons-png.flaticon.com/512/684/684908.png",
            iconImageSize: [ 40, 40 ],
            iconImageOffset: [ 0, 0 ]
    ...
    if (animItems.length > 0) {
        ...
        function animOnScroll() {
            for (let index = 0; index < animItems.length; index++) {
                ...
                if (pageYOffset > animItemOffset - 1600 && pageYOffset < animItemOffset + animItemHeight) animItem.classList.add("_active"); else if (!animItem.classList.contains("_anim-no-hide")) animItem.classList.remove("_active");
            }
        }
        function offset(el) {
